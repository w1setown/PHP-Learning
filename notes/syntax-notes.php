...
// The closing tag is optional in PHP files that contain only PHP code. It is not required by the PHP parser and can be omitted from files containing only PHP.
?>
...
//but this is not really the most optimal way to do things. There is no automatic syntax checking since it is only seen as PHP string, 
//therefore, it is not recommended to do it this way.
}
?>
...
<?php } ?>
<!-- What you can do instead, is you can split up your condition, using the opening and closing PHP tags, around the beginning of the statement and the closing of the statement -->
</body>