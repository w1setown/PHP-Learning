<?php
echo $_SERVER["DOCUMENT_ROOT"]; // shows the root directory of the server. It is the directory where the script is located. If the script is located in "C:/xampp/htdocs/test.php", it will show "C:/xampp/htdocs"
...
// echo $_COOKIE["name"]; // shows the value of the cookie named "name". Cookies are used to store data on the client's computer. They are often used to remember user preferences


echo "<br>";
echo $_SESSION["username"] = "John"; // sets the value of the session variable named "username" to "John". Sessions are used to store data on the server, which can be accessed across multiple pages
echo "<br>";
